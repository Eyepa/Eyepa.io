        ...
        <div class="card mb-3">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    @php($rest_sub = $restaurant->restaurant_sub)
                    {{-- {{dd($restaurant->restaurant_model == 'subscription' && isset($rest_sub) && $rest_sub->self_delivery == 1)}} --}}
                    @if (
                    ($restaurant->restaurant_model == 'subscription' && isset($rest_sub) && $rest_sub->self_delivery == 1) || ($restaurant->restaurant_model == 'commission' && $restaurant->self_delivery_system == 1))
                    <div class="col-lg-4 col-sm-6">
                        <div class="form-group m-0">
